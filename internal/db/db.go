...
type Store interface {
	...
	GetFeed(ctx context.Context, feedID int64) (*api.Feed, error) // nil, nil if missing
	UpdateFeed(ctx context.Context, feedID int64, title, url string) (api.Feed, error)
	SetFeedIcon(ctx context.Context, feedID int64, data []byte, mimeType string) error // nil data clears
	DeleteFeed(ctx context.Context, feedID int64) error
	UpsertItems(ctx context.Context, feedID int64, items []api.Item) error
	ListItems(ctx context.Context, feedID *int64, limit, offset int) ([]api.Item, error) // nil feedID: all feeds
	CountItems(ctx context.Context, feedID *int64) (int, error)                          // nil feedID: all feeds
